      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="order-2 lg:order-1 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <button
              type="button"
              className="order-2 lg:order-1 back-button border py-2 px-4 rounded text-gray-600 hover:underline dark:text-gray-300"
        ...
        <div className="order-1 lg:order-2">
          <div className="border px-4 py-6 bg-gray-100 dark:bg-gray-800 rounded-md">
      ...
      {success && (
        <div>
          ...
          <div className="fixed left-0 top-0 w-full h-full flex items-center justify-center z-20 ">
            <div className="relative m-6 p-6 md:p-12 bg-white flex flex-col gap-8 items-center justify-center bg-white border rounded-lg dark:bg-gray-800">
              <Link
                href="/dashboard"
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="mt-2 text-gray-500 text-center dark:text-gray-300">
